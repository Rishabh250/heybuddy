...
class LocalNotification {
  Future<void> initializeLocalNotificationSettings(
      {bool changeNotification = false}) async {
  ...
  String _notification = 's';
  showNotifications() async {
    await flutterLocalNotificationsPlugin.show(
        0, _notification, _notification, firstNotificationPlatformSpecifics,
        payload: jsonEncode({"Data": "Got it."}));
  }
