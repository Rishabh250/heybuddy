...
class AspirantRefund extends StatefulWidget {
  var index;
  AspirantRefund({required this.index});
  // const AppointmentBooked({Key? key}) : super(key: key);

  @override
  _AspirantRefundState createState() => _AspirantRefundState();
}

class _AspirantRefundState extends State<AspirantRefund> {
  @override
  void initState() {
