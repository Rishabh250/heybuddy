...
class ProCancel extends StatefulWidget {
  var index;
  ProCancel({required this.index});
  // const AppointmentBooked({Key? key}) : super(key: key);

  @override
  _ProCancelState createState() => _ProCancelState();
}

class _ProCancelState extends State<ProCancel> {
  @override
  void initState() {
