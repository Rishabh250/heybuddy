...
import 'package:heybuddy/api/signinphone.dart';
...
class LoginOtpScreen extends StatefulWidget {
  ...
  var phone;
  var codeDigits;
  LoginOtpScreen({required this.phone, required this.codeDigits});
  @override
...
class _LoginOtpScreenState extends State<LoginOtpScreen> {
  ...
  signinphone() async {
    ...
    output = await SignInByPhone.phone(widget.phone, firetkn);
    return output;
  }
