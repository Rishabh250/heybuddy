...
class SeeAllEducation extends StatefulWidget {
  var uniqueid;
  SeeAllEducation({required this.uniqueid});
  // const SeeAllEducation({Key? key}) : super(key: key);

  @override
  _SeeAllEducationState createState() => _SeeAllEducationState();
}

class _SeeAllEducationState extends State<SeeAllEducation> {
  @override
  void initState() {
    super.initState();
    onTap();
  ...
  geteducationlength() async {
    y = output['user'][0]["education"].length;
    print("vy  is$y");
    return y;
  }
